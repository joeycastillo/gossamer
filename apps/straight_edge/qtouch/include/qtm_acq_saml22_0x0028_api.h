/*============================================================================
Filename : qtm_acq_saml22_api.h
Project : QTouch Modular Library
Purpose : API for Acquisition module - SAML22/PTC
------------------------------------------------------------------------------
...
/* Acquisition module SAML22 Sequential */
typedef struct {
...
typedef struct {
	...
	qtm_acq_saml22_node_config_t(*qtm_acq_node_config);
...
typedef void (*qtm_drivenshield_callback_t)(uint8_t csd, uint8_t sds, uint8_t prescaler, uint32_t volatile *ptr,
                                            uint32_t value);
...
/*============================================================================
void qtm_drivenshield_register_complete_callback(qtm_drivenshield_callback_t callback);
------------------------------------------------------------------------------
Purpose: register the drivenshield complete callback with the touch library
Input  : pointer to the applicaion function to stop the drivenshield timer
Output : touch_ret_t
Notes  :  the library initialises this with a null, if this remains the the
         library will function as normal, if this is not null then the
         application will have some code to stop the drivenshield timer
============================================================================*/
void qtm_drivenshield_register_complete_callback(qtm_drivenshield_callback_t callback);
/*============================================================================
...
/*============================================================================
uint16_t qtm_saml22_acq_module_get_id(void);
------------------------------------------------------------------------------
...
/*============================================================================
uint8_t qtm_saml22_acq_module_get_version(void);
------------------------------------------------------------------------------
...
/*============================================================================
void qtm_saml22_ptc_handler_eoc(void)
------------------------------------------------------------------------------
