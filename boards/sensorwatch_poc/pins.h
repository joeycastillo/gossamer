...
HAL_GPIO_PIN(SCK,  B, 0)
HAL_GPIO_PIN(MOSI, B, 0)
HAL_GPIO_PIN(CS,   B, 0)
#define SPI_SERCOM 3
...
// Temperature sensor
HAL_GPIO_PIN(TS_ENABLE, B, 0)
HAL_GPIO_PIN(TEMPSENSE, B, 0)

// IR Sensor
#define HAS_IR_SENSOR
HAL_GPIO_PIN(IR_ENABLE, B, 0)
HAL_GPIO_PIN(IRSENSE, B, 0)
...
#define WATCH_GREEN_TCC_CHANNEL 4
#define WATCH_BLUE_TCC_CHANNEL 7
...
// Buttons
HAL_GPIO_PIN(BTN_LIGHT,  A, 31)
HAL_GPIO_PIN(BTN_MODE,   A, 30)
HAL_GPIO_PIN(BTN_ALARM,  A,  2)
HAL_GPIO_PIN(BTN_ADJUST, A,  3)
...
HAL_GPIO_PIN(SLCD17, A, 14)
HAL_GPIO_PIN(SLCD18, A, 15)
HAL_GPIO_PIN(SLCD19, A, 16)
HAL_GPIO_PIN(SLCD20, A, 17)
HAL_GPIO_PIN(SLCD21, A, 18)
HAL_GPIO_PIN(SLCD22, A, 19)
HAL_GPIO_PIN(SLCD23, B, 16)
HAL_GPIO_PIN(SLCD24, B, 17)
HAL_GPIO_PIN(SLCD25, A, 20)
HAL_GPIO_PIN(SLCD26, A, 21)
HAL_GPIO_PIN(SLCD27, A, 23)
